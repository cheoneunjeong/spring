...
-- 테이블 데이터 jung.sanswer:~38 rows (대략적) 내보내기
...
-- 테이블 데이터 jung.userauth:~8 rows (대략적) 내보내기
...
-- 테이블 데이터 jung.userlist:~7 rows (대략적) 내보내기
...
INSERT INTO `userlist` (`u_id`, `u_password`, `u_name`, `u_phone`, `u_datetime`, `u_isAccountNonExpired`, `u_isAccountNonLocked`, `u_isCredentialNonExpired`, `u_isEnabled`, `u_auth`) VALUES
	('aaaa', '$2a$10$ZjSWC05BClkPVH67MEGoEu6lq/vg83c0rlL.CiU0aEdatIb4DfQci', 'aaaa', 123, '2022-01-05 10:47:18', NULL, 1, 1, 1, 0),
	('abc', '$2a$10$08XR0uPaiUX.YWh9pxGu8.suYdnnp/m2XsxPj0dxi7mbCRi8ej1Vq', 'abc', NULL, '2021-12-06 09:28:58', 1, 1, 1, 1, 0),
	('c', '$2a$10$OHE7XzHKtO25Vo5Hk4QTKOEW1ecLCrisEwdlh7HNIgUfxcu5fxNiK', 'c', 1234563, '2021-12-06 09:32:58', 1, 1, 1, 1, 1),
	('f', '$2a$10$pUNFLNdoip4ZEgLCKpiaTenl1qOH2geZlls7/YyrbKjBw17L2Yd.S', 'f', 21124, '2022-01-05 10:48:13', 1, 1, 1, 1, 0),
	('qqq', '$2a$10$m84mPoZUFe0TNsuMs76Zh.qsYVRgwggh5FxyHS6xv6NKIcCH.G1Jy', 'qqq', NULL, '2021-12-10 11:29:09', 1, 1, 1, 1, 0),
	('test', '$2a$10$hUKBj0KXyq.LedcVeqv4YONVdE2yzwF7Uk.G2rYmcCsNBOQe3RXoG', 'test', NULL, '2021-12-04 14:25:02', 1, 1, 1, 1, 0),
	('tt', '$2a$10$QLbzS8zTg1.2WJ2LSdrMLOoU6FRzDXJGj8TyBoePrVK/3//ZTEswe', 'tt', NULL, '2021-12-04 14:25:23', 1, 1, 1, 1, 0),
	('zaza', '$2a$10$aKo6SCUkDM8OFvkAfB2dKegmqPgIE329b.FihTSsrmA5SLUbvVHwK', 'zaza', NULL, '2021-12-10 11:32:44', 1, 1, 1, 1, 0),
	('zzz', '$2a$10$56ZyDNrLcaSl7HMDKA8aCe.nBS4FR.gdNSV8BqMpwItW7I6bNQTGa', 'zzz', 10000000, '2022-01-05 10:34:27', NULL, 1, 1, 1, 0);
